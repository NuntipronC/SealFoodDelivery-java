...
public class menulo01 extends javax.swing.JFrame {
        public static int count_menu01 = 0;
        public static String[][]menu01 = new String[10][2];
    ...
    public menulo01() {
        initComponents();
        restaurant1.setText(adminpage.location[0][0]);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_menu01, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 270, 230, 38));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/03menu1.jpg"))); // NOI18N
    ...
    private void bt_addmenu01ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_addmenu01ActionPerformed
        DefaultTableModel model1 = (DefaultTableModel)jTable_menu01.getModel();
         menu01[count_menu01][0] = txt_menu01.getText();
         menu01[count_menu01][1] = txt_addprice01.getText();
         for (int i = count_menu01;i <= count_menu01; i++){
            String row[] = new String[menu01[i].length];
            for (int j=0; j<menu01[i].length; j++){
                row[j] = menu01[i][j];
            }
            model1.addRow(row);
        }
        count_menu01 = count_menu01+1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menulo01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
